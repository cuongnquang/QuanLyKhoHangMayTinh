...
public class ThongKeForm extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            for (int i = 0; i < allPhieu.size(); i++) {
                tblModel.addRow(new Object[]{
                    allPhieu.get(i).getMaPhieu(), AccountDAO.getInstance().selectById(allPhieu.get(i).getNguoiTao()).getFullName(), formatDate.format(allPhieu.get(i).getThoiGianTao()), formatter.format(allPhieu.get(i).getTongTien()) + "đ"
                });
            }
        } catch (Exception e) {
        }
    ...
    private void loadDataToTableSearch(ArrayList<Phieu> result) {
        try {
            ...
            for (int i = 0; i < result.size(); i++) {
                tblModel.addRow(new Object[]{
                    result.get(i).getMaPhieu(), AccountDAO.getInstance().selectById(result.get(i).getNguoiTao()).getFullName(), formatDate.format(result.get(i).getThoiGianTao()), formatter.format(result.get(i).getTongTien()) + "đ"
                });
            }
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        jPanel3.add(jTextFieldSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 30, 640, 40));
        ...
        jPanel3.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 30, 140, 40));
        ...
        jComboBoxLuaChon1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Họ và tên", "Tên đăng nhập", "Vai trò" }));
        ...
        jPanel7.add(jTextFieldSearch1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 30, 710, 40));
        ...
        jPanel7.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 30, 160, 40));
