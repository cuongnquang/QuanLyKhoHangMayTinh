...
public class ChiTietPhieu {
    ...
    public ChiTietPhieu(String maPhieu, MayTinh mayTinh, int soLuong, double donGia) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.mayTinh, other.mayTinh);
    }

    @Override
    public String toString() {
        return "ChiTietPhieu{" + "maPhieu=" + maPhieu + ", maMay=" + mayTinh + ", soLuong=" + soLuong + ", donGia=" + donGia + '}';
    }
